            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-4 col-xs-12">
                    <div class="x_panel tile fixed_height_320">
                        <div class="x_title">
                            <h2>Data Transaksi Proyek dari total <?= $chartproyek['totalproyek']?> proyek</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-4 col-xs-12">
                    <div class="x_panel tile fixed_height_320">
                        ...
                        <div class="x_content">
                            <table id="UserBaruTable" class="table table-striped table-bordered table-responsive">
                                <thead>
                                <tr>
                                    <th>ID User</th>
                                    <th>Nama user</th>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <table id="ProyekBaruTable" class="table table-striped table-bordered table-responsive">
                                <thead>
                                <tr>
                                    <th>ID Proyek</th>
                                    <th>Nama Proyek</th>
        ...
        <script>
            ...
            $(document).ready(function() {
                manageTable = $('#UserBaruTable').DataTable({

                    'ajax': '<?= site_url('/')?>Dashboard/fetchUserNewData',

                    'order': []

                });
                 proyekbaru = $('#ProyekBaruTable').DataTable({

                    'ajax': '<?= site_url('/')?>Dashboard/fetchProyekNewData',
