<!-- page content -->
    <div class="right_col" role="main">
        ...
        <div class="">
            ...
            <br>
            <a href="<?= site_url('Settings/addfaq') ?>" class="btn btn-success">Tambah FAQ</a>
            <br>
            <br>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Frequently Asked Questions<small>List</small></h2>
                                <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <table id="faqTable" class="table table-striped table-bordered table-responsive">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Pertanyaan</th>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <form role="form" action="<?php echo site_url('Settings/removefaq') ?>" method="post" id="removeBrandForm">
...
<script src="<?= base_url('assets/admin/vendors/pdfmake/build/vfs_fonts.js') ?>"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            manageTable = $('#faqTable').DataTable({
