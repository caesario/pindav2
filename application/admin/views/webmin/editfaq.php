        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form role="form" action="<?= site_url('Settings/editfaq/'.$faq['id_faq']) ?>" method="post">

                        <div class="box-body">
                            <?php echo validation_errors(); ?>
                            <br>
                            <div class="form-group">
                                <label for="id_tentang">ID FAQ</label>
                                <input type="text" class="form-control" id="id_faq" name="id_faq"  value="<?= $faq['id_faq']?>" autocomplete="off" disabled/>
                                <input type="hidden" class="form-control" id="id_faq" name="id_faq" value="<?= $faq['id_faq']?>" autocomplete="off"/>
                            </div>
                            <div class="form-group">
                                <label for="judul_tanya">Pertanyaan</label>
                                <input type="text" class="form-control" id="judul_tanya" name="judul_tanya" placeholder="Masukkan Pertanyaan" value="<?= $faq['judul_tanya']?>" autocomplete="off"/>
                            </div>

                            <div class="form-group">
                                <label for="jawaban_tanya">Jawaban</label>
                                <textarea type="text" class="form-control" id="jawaban_tanya" name="jawaban_tanya" placeholder="Masukkan Jawaban" autocomplete="off" rows="13" cols="20"><?= $faq['jawaban_tanya']?></textarea>
                            </div>
                            <div class="clearfix"></div>
                            <br>
