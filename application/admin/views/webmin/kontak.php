        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Kontak<small> Pinda</small></h3>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form role="form" action="<?= site_url('Settings/kontak') ?>" method="post">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="id_kontak" name="id_kontak"  value="<?= $kontak['id_kontak']?>" autocomplete="off" disabled/>
                                <input type="hidden" class="form-control" id="id_kontak" name="id_kontak" value="<?= $kontak['id_kontak']?>" autocomplete="off"/>
                            </div>

                            <div class="form-group">
                                <label for="telepon">Telepon</label>
                                <input type="text" class="form-control" id="telepon" name="telepon" value="<?= $kontak['telepon']?>" autocomplete="off"/>
                            </div>

                            <div class="form-group">
                                <label for="whatsapp">Whatsapp</label>
                                <input type="text" class="form-control" id="whatsapp" name="whatsapp" value="<?= $kontak['whatsapp']?>" autocomplete="off"/>
                            </div>

                            <div class="form-group">
                                <label for="line">Line ID</label>
                                <input type="text" class="form-control" id="line" name="line" value="<?= $kontak['line']?>" autocomplete="off"/>
                            </div>

                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="text" class="form-control" id="email" name="email" value="<?= $kontak['email']?>" autocomplete="off"/>
                            </div>
                            <div class="clearfix"></div>
